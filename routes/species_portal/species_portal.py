...
def add_species_to_database():
    ...
    try:
        ...
        add_species(
            eng_name, latin_name, main_text, category, extinction_risk, image_id
        )
        ...
        flash(
            f"{species_to_edit['species_english']} already exists. You have been redirected to the editor to update it.",
            "info",
        )
